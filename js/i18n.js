...
(function (racine) {
  ...
  const TEXTES = {
    ...
    fr: {
      ...
      'conv.voix.aucune': 'Aucune voix installée pour cette langue ({langue}) sur cet appareil : le dialogue se lit, mais ne s’écoute pas.',
      'conv.voix.desactivee': 'La lecture à voix haute est désactivée dans les Réglages.',
      'conv.provenance.fourni': 'Rédigé pour l’application par un assistant d’écriture (Claude), vérifié par des contrôles automatiques, non relu par un locuteur natif.',
      ...
      'reglages.apropos.conversation': 'Phrases et dialogues : contenu original de l’application (CC BY-SA 4.0), rédigé par un assistant d’écriture et non relu par un locuteur natif.',
    ...
    de: {
      ...
      'conv.voix.aucune': 'Für diese Sprache ({langue}) ist auf diesem Gerät keine Stimme installiert: der Dialog lässt sich lesen, aber nicht anhören.',
      'conv.voix.desactivee': 'Das Vorlesen ist in den Einstellungen ausgeschaltet.',
      'conv.provenance.fourni': 'Für die Anwendung von einem Schreibassistenten (Claude) verfasst, automatisch geprüft, nicht von Muttersprachlern durchgesehen.',
      ...
      'reglages.apropos.conversation': 'Sätze und Dialoge: eigener Inhalt der Anwendung (CC BY-SA 4.0), von einem Schreibassistenten verfasst und nicht von Muttersprachlern durchgesehen.',
